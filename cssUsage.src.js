...
/* 
    RECIPE: caretRangeFromPoint
    -------------------------------------------------------------
    Author: Grisha Lyukshin
    Description: Find use of caretRangeFromPoint in script.
*/

void function() {
    window.CSSUsage.StyleWalker.recipesToRun.push( function caretRangeFromPoint(/*HTML DOM Element*/ element, results) {
        var nodeName = element.nodeName;
        var script = ".caretRangeFromPoint"
        if (nodeName == "SCRIPT")
        {
